...
Hci.prototype.setScanParameters = function() {
  ...
  cmd.writeUInt16LE(0x3E80, 5); // scan interval *0.625 ms (default 0x0010)
  cmd.writeUInt16LE(0x3E80, 7); // scan window *0.625 (default 0x0010)
...
Hci.prototype.createLeConn = function(address, addressType) {
  ...
  // data
  cmd.writeUInt16LE(0x3E80, 4); // scan interval *0.625 ms (default 0x0060)
  cmd.writeUInt16LE(0x3E80, 6); // scan window *0.625 (default 0x0030)
  ...
  cmd.writeUInt16LE(0x0006, 17); // min connection interval *1.25   7.5ms - 4s  0x06 => 7.5ms
  cmd.writeUInt16LE(0x000c, 19); // max connection interval *1.25   7.5ms - 4s  0x0c => 15ms
  cmd.writeUInt16LE(0x0000, 21); // latency // wieviele darf der client auslassen
  cmd.writeUInt16LE(0x00c8, 23); // supervision timeout *10ms
  cmd.writeUInt16LE(0x0004, 25); // min ce length *0.625
  cmd.writeUInt16LE(0x0006, 27); // max ce length *0.625
